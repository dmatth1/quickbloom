...
//
// One implementation, two configurations. Compile with
//   -DPREFETCH_LOOKAHEAD=0   -> "single_key" variant (lowest in-cache latency)
//   -DPREFETCH_LOOKAHEAD=8   -> "unified" variant (good across cache hierarchy)
//
